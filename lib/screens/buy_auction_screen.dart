...
class BuyAuctionScreen extends StatefulWidget {
  const BuyAuctionScreen({Key? key}) : super(key: key);

  @override
  _BuyAuctionScreenState createState() => _BuyAuctionScreenState();
}

class _BuyAuctionScreenState extends State<BuyAuctionScreen> {
  @override
