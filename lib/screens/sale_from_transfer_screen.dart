...
class SaleFromTransfer extends StatefulWidget {
  const SaleFromTransfer({Key? key}) : super(key: key);

  @override
  _SaleFromTransferState createState() => _SaleFromTransferState();
}

class _SaleFromTransferState extends State<SaleFromTransfer> {
  @override
